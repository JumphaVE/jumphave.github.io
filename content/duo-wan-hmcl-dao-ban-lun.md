...
或许世界上找不到那么几个用Java编写并且不使用任何物理引擎开发的游戏，所以我的世界是独一无二举世无双的奇迹，如果硬是要说出每个语言对应的巅峰之作，那我想c语言必然是linux和git，python必然是blender，Java当然就是————我的世界！让每个语言编写的巅峰之作联合起来吧！
